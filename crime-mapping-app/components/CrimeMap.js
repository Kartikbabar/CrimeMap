...
const AdvancedCrimeHeatmap = ({ userRole, userDistrict }) => {
  ...
  const getFilteredCrimes = () => {
    let filtered = maharashtraCrimeData;
      ...
      <div style={{
        ...
        <div>
          <h2 style={{
            ...
            Maharashtra Crime Intelligence Map
          </h2>
          <p style={{
            color: '#64748b',
            fontSize: '0.875rem'
            ...
            {userRole === 'police' 
              ...
              : 'Crime visualization across Maharashtra'
            }
          </p>
        </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '8px',
                border: 'none',
                backgroundColor: selectedView === 'heatmap' ? '#3b82f6' : 'transparent',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '8px',
                border: 'none',
                backgroundColor: selectedView === 'points' ? '#3b82f6' : 'transparent',
            ...
            {Object.entries(districtStats)
              ...
              .map(([district, stats]) => (
                <div key={district} style={{
                  ...
                  borderRadius: '8px',
                  border: `2px solid ${
                    getRiskLevel(district) === 'high' ? '#fecaca' :
